...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'linklists', 'Post Type General Name', 'twentythirteen' ),
        'singular_name'       => _x( 'linklist', 'Post Type Singular Name', 'twentythirteen' ),
        'menu_name'           => __( 'Link Lists', 'twentythirteen' ),
        'parent_item_colon'   => __( 'Parent linklists', 'twentythirteen' ),
        'all_items'           => __( 'All Link Lists', 'twentythirteen' ),
        'view_item'           => __( 'View Link List', 'twentythirteen' ),
        'add_new_item'        => __( 'Add New Link List', 'twentythirteen' ),
        'add_new'             => __( 'Add New', 'twentythirteen' ),
        'edit_item'           => __( 'Edit Link List', 'twentythirteen' ),
        'update_item'         => __( 'Update Link List', 'twentythirteen' ),
        'search_items'        => __( 'Search Link List', 'twentythirteen' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        'label'               => __( 'linklists', 'twentythirteen' ),
        'description'         => __( 'Link List news and reviews', 'twentythirteen' ),
        'labels'              => $labels,
    ...
    register_post_type( 'linklists', $args );
...
function tr_create_my_taxonomy() {
    ...
    register_taxonomy(
        ...
        array(
            'label' => __( 'Category' ),
            'rewrite' => array( 'slug' => 'linklists-category' ),
            'hierarchical' => true,
        )
    );
}
...
function add_my_post_types_to_query( $query ) {
    if ( is_home() && $query->is_main_query() )
        $query->set( 'post_type', array( 'post', 'linklists' ) );
    return $query;
}
    ...
    if ( $query->have_posts() ) { ?>
        <ul class="clothes-listing">
            ...
            <li id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <a href="<?php echo get_post_meta( get_the_ID(), '_global_notice', true ); ?>"><?php the_title(); ?></a>
            </li>
            <?php endwhile;
            wp_reset_postdata(); ?>
        </ul>
