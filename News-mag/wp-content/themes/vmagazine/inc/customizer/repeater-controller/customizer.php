...
*/
  function vmagazine_enqueue_repeater_scripts() {
    wp_enqueue_script( 'riple-pro-repeater-script', get_template_directory_uri() . '/inc/customizer/repeater-controller/repeater-script.js',array( 'jquery','jquery-ui-sortable'));
    wp_enqueue_style('riple-pro-repeater-style',get_template_directory_uri() . '/inc/customizer/repeater-controller/repeater-style.css');
} add_action( 'admin_enqueue_scripts', 'vmagazine_enqueue_repeater_scripts');

/**
* Repeater customizer
*/
add_action( 'customize_register', 'vmagazine_repeaters_customize_register' );
function vmagazine_repeaters_customize_register( $wp_customize ) {
...
*
*/
$wp_customize->add_setting( 'vmagazine_social_icons', array(
    'sanitize_callback' => 'vmagazine_sanitize_repeater',
...
$wp_customize->add_control(  new Vmagazine_Repeater_Controler( $wp_customize, 'vmagazine_social_icons', 
    array(
        'label'                     => esc_html__('Social Icons Option','vmagazine'),
        'section'                   => 'vmagazine_header_icons',
        'vmagazine_box_label'         => esc_html__('Social Icons','vmagazine'),
        'vmagazine_box_add_control'   => esc_html__('Add Profile','vmagazine'),
    ),
        array(
            'social_icons' => array(
            'type'        => 'social_icon',
            'label'       => esc_html__( 'Choose Icon', 'vmagazine' ),
            'default'     => '',
            ...
            'social_url' => array(
            'type'        => 'url',
            'label'       => esc_html__( 'Enter URL', 'vmagazine' ),
            'default'     => '',
            'class'       => 'un-bottom-block-cat1'
            ),  
            'url_target' => array(
            'type'        => 'checkbox',
            'label'       => esc_html__( 'Open Link In New Tab?', 'vmagazine' ),
            'default'     => '',
            'class'       => 'un-bottom-block-cat1'
            )  
        )
        ...
        * Repeater Sanitize
        */
        function vmagazine_sanitize_repeater($input){      
 ...
 * @since 1.0.0
 */
 function vmagazine_icons_array(){
    $ap_icon_list_raw = 
 ...
 *
 */
 function vmagazine_social_icons_arrays(){
