...
// Search popup module
if(
		( tie_get_option( 'top_nav' )  && tie_get_option( 'top-nav-components_search' )  && tie_get_option( 'top-nav-components_search_layout' )  == 'compact' ) ||
		( tie_get_option( 'main_nav' ) && tie_get_option( 'main-nav-components_search' ) && tie_get_option( 'main-nav-components_search_layout' ) == 'compact' )
	){
