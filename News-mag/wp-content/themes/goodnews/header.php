...
<?php wp_head(); ?>
    ...
    ?>
	    ...
	    <div id="header-wrapper">
            ...
            ?>
            <header class="header <?php echo esc_attr($logo_position); ?>" itemscope="itemscope" itemtype="http://schema.org/WPHeader" role="banner">
                <div class="inner">
					<?php mom_logo(); ?>
                    <?php
			...
			if (is_singular()) {
			    //custom banner
				$custom_header_banner = get_post_meta(get_queried_object_id(), 'mom_Header_banner', true);
			    if ($custom_header_banner)  {
					$header_banner = $custom_header_banner;
				}
				
			} elseif (is_category()) {
			    //custom banner
			    $custom_header_banner = isset($cat_data['custom_banner']) ? $cat_data['custom_banner'] :'';
			    if ($custom_header_banner)  {
					$header_banner = $custom_header_banner;
				}
			}
