...
elseif ( get_query_var('page') ) { $paged = get_query_var('page'); }
                ...
                <?php if ($search_page_style == 'blog') { ?>
                        <?php if ( $s && $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>
				...
				?>
                                ...
                                <div class="news-summary <?php echo $is_img; ?>">
                                   ...
                                   <div class="mom-post-meta nb-item-meta">
                                    ...
                                    <a href="<?php comments_link(); ?>" class="comment_number"><?php comments_number(__('No comments', 'theme'), __('1 Comment', 'theme'), __('% Comments', 'theme')); ?></a>
