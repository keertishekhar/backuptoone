...
/* ==========================================================================
       Feathure slider
   ========================================================================== */
if (!function_exists('mom_elements_feature_slider')) {
...
$style = 'new';
	...
	<div class="fslides fs-<?php echo $rndn; ?>">
		...
		if ($display == 'category') {
			...
			'posts_per_page' => $count, 'post_type' => $post_type, 'category__not_in' => $exclude_categories, 'post_status' => 'publish', 'cache_results' => false, 'no_found_rows' => true, 'post__not_in' => $do_unique_posts,
			'cat' => $category,
			'orderby' => $orderby,
		);
...
/* ==========================================================================
       News List
   ========================================================================== */
if (!function_exists('mom_elements_news_list')) {
 ...
 *                News Boxes
   ========================================================================== */
if (!function_exists('mom_elements_news_boxes')) {
...
<?php if($style == 2) { ?>
		...
		if ($display == 'category') {
			$args = array(
			'ignore_sticky_posts' => 1,
			'posts_per_page' => 1, 'post_type' => $post_type, 'category__not_in' => $exclude_categories, 'post_status' => 'publish', 'cache_results' => false, 'no_found_rows' => true, 'post__not_in' => $do_unique_posts,
			'cat' => $category,
			'orderby' => $orderby,
			'order' => $sort,
			);
...
<?php } elseif ($style == 4) { ?>
		...
		if (!is_numeric($category)) {$args['category_name'] = $category;}
			...
			$args = array(
			'ignore_sticky_posts' => 1, 'post_type' => $post_type, 'category__not_in' => $exclude_categories, 'post_status' => 'publish', 'cache_results' => false, 'no_found_rows' => true, 'post__not_in' => $do_unique_posts,
			'posts_per_page' => 1,
			'tag_id' => $tag,
			'orderby' => $orderby,
			'order' => $sort,
...
/* ==========================================================================
	media box
   ========================================================================== */
if (!function_exists('mom_elements_media_box')) {
...
/* ==========================================================================
       News In pics
   ========================================================================== */
if (!function_exists('mom_elements_news_in_pics')) {
...
?>
		...
		if ($display == 'category') {
			...
			'posts_per_page' => 1,
			'cat' => $category,
			'post_type' => $post_type, 'category__not_in' => $exclude_categories, 'post_status' => 'publish', 'cache_results' => false, 'no_found_rows' => true, 'post__not_in' => $do_unique_posts,
			'orderby' => $orderby,
			'order' => $sort,
			);
		if (!is_numeric($category)) {$args['category_name'] = $category;}
