...
$data = wp_remote_get('https://graph.facebook.com/v3.1/' . $page_id .'?fields=fan_count,link&access_token='.$facebook_access_token);
	if (!is_wp_error($data)) {
...
//delete_transient('mom_instagram_followers_'.$instagram);
