...
$logos = MOM_ADDON_URI . '/assets/images/';
	$plugins = array(
		...
		array(
			'name'     				=> 'Shortcodes editor',
			'slug'     				=> 'goodnews-shortcode-editor',
			'source'   				=> get_template_directory() . '/framework/plugins/goodnews-shortcode-editor.zip',
			'required' 				=> true,
			'version' 				=> '1.2',
			'external_url' 			=> '',
		...
		array(
			...
			'version' 				=> '2.0.1',
			'external_url' 			=> '',
			'logo'				=> $logos . 'envato-market.png',
			'author'			=> 'Envato',
			'desc'				=> 'This plugin helps customers receive updates to their premium Themes & Plugins purchased through Envato Market (ThemeForest & CodeCanyon)',
			'type'				=> 'addon',
		),
