<?php
	...
	if(!empty($pro_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Pro Plugins', 'one-paze'); ?></h4>
		<p><?php echo esc_html__('Take Advantage of some of our Premium Plugins', 'one-paze'); ?></p>
	...
	if(!empty($free_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Free Plugins', 'one-paze'); ?></h4>
		<p><?php echo esc_html__('These Free Plugins might be handy for you.', 'one-paze'); ?></p>
		<div class="recomended-plugin-wrap">
		<?php
