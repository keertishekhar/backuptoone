...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?> >
        ...
        ?>
        <div id="togglemenu" class="sidetogglemenu <?php echo esc_attr($smenu_class); ?>">
            <!-- Your content -->
                ...
                <?php if(is_page_template('tpl-home.php')) : ?>
                    <?php if($disp_parallax_menu) : ?>
                        <ul class="nav plx-nav">
                            ...
                            <li><a href="<?php echo esc_url(home_url()); ?>/#plx-slider-section" ><?php esc_html_e('Home', 'one-paze'); ?></a></li>
                            <?php
                            ...
                            foreach ($enabled_sections as $enabled_section) :
                                ...
                                <li><a href="<?php echo esc_url(home_url()); ?>/#plx_<?php echo esc_attr($enabled_section['section']); ?>_section" ><?php echo esc_attr($enabled_section['menu_text']); ?></a></li>
                                <?php endif; ?>
                                <?php
                            endforeach;
                            ?>
        ...
        <div id="page" class="hfeed site">
            ...
            <header id="masthead" class="site-header menu-on-<?php echo esc_attr($show_menu_on); ?>" role="banner">
                ...
                <div class="container clearfix">
                    ...
                    <?php if ($show_menu_on == 'top' || $show_menu_on == '') : ?>
                        <div id="toggle" class="toggle-on-<?php echo esc_attr($show_menu_on); ?>">
                            <div class="one"></div>
                            <div class="two"></div>
                            <div class="three"></div>
                        </div>
                        <div class="clearfix"></div>
                        <div id="menu" class="inner-menu-on-<?php echo esc_attr($show_menu_on); ?>">
                            <nav id="site-navigation" class="main-navigation" role="navigation">
                                <?php if($disp_parallax_menu) : ?>
                                    <ul class="nav plx-nav">
                                        <span class="siteurl" url="<?php echo esc_url(home_url('/')); ?>" style="display: none;"></span>
                ...
                <?php else : ?> 
                    <div class="header-banner">
                        <div class="container" >
                            ...
                            <?php elseif (is_home()) : ?>
                                <h1 class="entry-title"><?php esc_html_e('Blogs', 'one-paze'); ?></h1>
                            <?php elseif (is_search()) : ?>
                                    <h1 class="page-title"><?php /* translators: %s : search keyword */ printf(esc_html__('Search Results for: %s', 'one-paze'), '<span>' . get_search_query() . '</span>'); ?></h1>
                            <?php elseif (is_404()) : ?>
                                <h1 class="page-title">
                ...
                <div class="header-banner">
                    <div class="container" >
                        ...
                        <?php elseif (is_home()) : ?>
                            ...
                            ?>
                            <h1 class="entry-title"><?php echo esc_html($blog_page->post_title); ?></h1>
                        <?php elseif (is_search()) : ?>
                            <h1 class="page-title"><?php /* translators: %s : search keyword */ printf(esc_html__('Search Results for: %s', 'one-paze'), '<span>' . get_search_query() . '</span>'); ?></h1>
                        <?php elseif (is_404()) : ?>
                            <h1 class="page-title">
