        ...
        <div class="blog-post-content">
            ...
            <div class="post-meta-infos">
                <span class="entry-footer-wrapper clearfix">
                    ...
                    ?>
                    <span class="author user-wrapper"><i class="fa fa-user"></i><a href="<?php echo esc_url($aulink); ?>"><?php echo esc_attr(get_the_author_meta('nickname')); ?></a></span>
                    <span class="posted-date user-wrapper"><i class="fa fa-calendar"></i><a href="<?php echo esc_url(get_month_link($year, $month)); ?>"><?php the_time( get_option( 'date_format' )); ?></a></span>
                    <?php if (has_category()) : ?>
                    ...
                    <?php if ($blog_layout != 'blog_full_content') : ?>
                        <span class="readmore">
                            <a href="<?php the_permalink(); ?>">
                                <?php esc_html_e('Read More...', 'one-paze'); ?>
                            </a>
                        </span>
                    <?php endif; ?>
                </span>
